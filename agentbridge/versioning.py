...
ADOPTED_DEPENDENCIES = {
    ...
    "openai_agents": {
        ...
        "notes": (
            ...
            "structured output, handoff/guardrail/MCP/run options, best-effort events, and "
            "extension metadata; approval/resume flows remain extension-level."
        ),
    },
    "google_adk": {
        "package": "google-adk",
        ...
        "notes": (
            ...
            "for sessions, memory, artifacts, evals, and deployment. "
    ...
    "strands": {
        ...
        "notes": (
            ...
            "summaries, and best-effort stream event normalization. Guardrail labels and deployment remain "
            "extension-level."
        ),
    },
    "langchain": {
