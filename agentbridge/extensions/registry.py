    ...
    return [
        ...
        ExtensionProfile(
            ...
            notes=[
                ...
                "Structured output is validated through ADK output_schema plus AgentBridge typed validation; run diagnostics summarize sessions, services, event history, transfer-to-agent events, eval labels/runner bindings, and structured deployment metadata.",
