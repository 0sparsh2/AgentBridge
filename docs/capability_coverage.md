...
- `agentbridge-strands`: Strands Agent/tool mapping, MCP clients with local stdio fixture coverage, hook/intervention/guardrail lifecycle events, structured output, run diagnostics, tracing, and structured AWS/AgentCore deployment metadata.
